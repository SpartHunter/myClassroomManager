...
public class ClassroomRegisterController {
    ...
    @FXML
    private TableColumn <BottomNavigationButton, ClassroomTableButton> classroomBooking;
    @FXML
    private TableColumn <BottomNavigationButton, ClassroomTableButton> classroomModify;
    @FXML
    private TableColumn <BottomNavigationButton, ClassroomTableButton> classroomDelete;
